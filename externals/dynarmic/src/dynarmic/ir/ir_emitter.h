...
public:
    ...
    U64 UnsignedMultiplyLong(const U32& a, const U32& b);
    ...
    U32 PackedSaturatedAddSubU16(const U32& a, const U32& b);
    U32 PackedSaturatedAddSubS16(const U32& a, const U32& b);
    U32 PackedSaturatedSubAddU16(const U32& a, const U32& b);
    ...
    U128 VectorShiftLeftInsert(size_t esize, const U128& destination, const U128& source, u8 shift_amount);
    U128 VectorShiftRightInsert(size_t esize, const U128& destination, const U128& source, u8 shift_amount);
    ...
    U128 VectorSignedMultiplyAccumulateWiden(size_t esize, const U128& accumulator, const U128& a, const U128& b, bool subtract);
    ...
    U128 VectorUnsignedMultiplyAccumulateWiden(size_t esize, const U128& accumulator, const U128& a, const U128& b, bool subtract);
