...
IR::Block A32AddressSpace::GenerateIR(IR::LocationDescriptor descriptor) const {
    ...
    Optimization::PolyfillPass(ir_block, {.extend_and_add = true, .pack_halfword = true, .packed_saturation16 = true, .vector_rounding_narrow = true, .vector_rounding_shift_right = true, .vector_shift_insert = true});
