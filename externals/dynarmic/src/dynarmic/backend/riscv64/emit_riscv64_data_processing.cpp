...
template<>
void EmitIR<IR::Opcode::SignedMultiplyLong>(biscuit::Assembler&, EmitContext&, IR::Inst*) {
    UNIMPLEMENTED();
}
...
template<>
void EmitIR<IR::Opcode::SignedMultiplySubtractLong>(biscuit::Assembler&, EmitContext&, IR::Inst*) {
    UNIMPLEMENTED();
}
...
template<>
void EmitIR<IR::Opcode::ByteReverseHalfwords32>(biscuit::Assembler&, EmitContext&, IR::Inst*) {
