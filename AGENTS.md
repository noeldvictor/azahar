...
- Track Thor performance findings in `docs/thor-optimization-notes.md`. Current top candidate is avoiding the hidden secondary-display render path when the Thor bottom display is not actively used.
