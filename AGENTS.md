...
- Thor GPU driver UX should stay simple: keep the guided driver picker with recommendation notes, manual ZIP fallback, and system-driver fallback working. The guide fetches K11MCH1 AdrenoToolsDrivers release assets at runtime and must validate `meta.json` before installing.
