...
| `arm_cortex_x3_software_optimization_guide.pdf` | Cortex-X3 | 1.12 MiB | `3EC100F2BBCD4DE004E1730553A3276BB27ECA4B320471B177BBDB843B8761D9` | Prime-core pipelines; AArch64 load table on pages 18-19 plus `USHL`, `SQXTUN`, one-table `TBL`, and `ZIP` tables on pages 27, 31, and 32 |
| `arm_cortex_a715_software_optimization_guide.pdf` | Cortex-A715 | 1.16 MiB | `D6D7A49F34528B79E1F8C8E0B02D59D3DA6011D719D3271D310A4D83EC8F6FA2` | Newer performance-core pair; AArch64 load table on pages 20-21 and corresponding ETC1 SIMD rows on pages 30, 34, and 35 |
| `arm_cortex_a710_software_optimization_guide.pdf` | Cortex-A710 | 1.39 MiB | `096B9C2924BBFA4C5045D2C2F1C711D6E544C28F2F04ADAAD4B66B2E8C48CD6A` | Older performance-core pair; AArch64 load table on pages 28-29 and corresponding ETC1 SIMD rows on pages 44, 52, and 53 |
| `arm_cortex_a510_software_optimization_guide.pdf` | Cortex-A510 | 1.22 MiB | `E80E25EFFBEE27FB95740420469846FA0B3211C5716757A464E5C32E63281D44` | Efficiency cores and shared vector resources; AArch64 load table on pages 23-24 and corresponding ETC1 SIMD rows on pages 37, 43, and 44 |
